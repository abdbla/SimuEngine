...
#pragma warning restore CS0612 // 'Simulation.Simulation(Graph, float, float, float, float)' is obsolete
        ...
        public void UpdateHud() {
            ...
            sDamp.Value = (int)(currentSimulation.Damping * 1000);
            ...
            {
                currentSimulation.Repulsion = sDamp.Value / 100;
            ...
            sGravity.Value = (int)(currentSimulation.Damping * 1000);
            ...
            {
                currentSimulation.Repulsion = sGravity.Value / 100;
            ...
            sRepulsion.Value = (int)(currentSimulation.Damping * 1000);
            ...
            {
                currentSimulation.Repulsion = sRepulsion.Value / 100;
            ...
            sStiffnes.Value = (int)(currentSimulation.Damping * 1000);
            ...
            {
                currentSimulation.Repulsion = sStiffnes.Value / 100;
